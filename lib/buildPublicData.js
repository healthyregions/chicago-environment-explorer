...
async function main() {
    ...
    // create postList.json and put it in /public
    // fs.list directory function on /public/content/posts
    // sort by date
    // EXCLUDE any not-published posts
    // make in JSON file like this:
    // {
    //   "posts": [
    //     {
    //       "title": frontmatter.title,
    //       "date": Date,
    //       "tagline": first 25 words of post
    //     },
    //     etc.
    //   ]
    // }
