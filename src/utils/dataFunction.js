...
const dataFn = (numeratorData, denominatorData, mapParams)  => {
  const { 
    nProperty, nIndex,
    dProperty, dIndex, 
    nType, dType,
  ...
  const nRange = nIndex <= mapParams.nRange ? nIndex : mapParams.nRange;
  const dRange = dIndex <= mapParams.dRange ? dIndex : mapParams.dRange;
