...
import { MemberGrid, NavBar, Footer } from '..';
...
export default function BlogPost(){
    ...
    const slug = useParams()[0];
    const mdUrl = `/public/content/posts/${slug}.md`

    const fetchMarkdown = async (url) => await fetch(mdUrl).then(r => r.text())
