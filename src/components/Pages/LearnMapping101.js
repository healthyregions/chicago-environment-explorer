       ...
       <LearnMapping101Page>
           ...
           <ContentContainer>
               ...
               <hr/>
                ...
                <br />
                <img src={'/img/learning-activities/mapping101-1.png'} alt={''} />
                <br />

                <p>Here is the legend for the map. Based on this legend, what is this map telling you?
                </p>

                <img src={'/img/learning-activities/mapping101-2.png'} alt={''} />
                ...
                <br />
                <img src={'/img/learning-activities/mapping101-3.png'} alt={''} />
                <br />
                ...
                <img src={'/img/learning-activities/mapping101-4.png'} alt={''} />
                <br />
                <br />
                ...
                <img src={'/img/learning-activities/mapping101-5.png'} alt={''} />
                <br />
                <br />
                ...
                <img src={'/img/learning-activities/mapping101-6.png'} alt={''} />
                <br />
                <br />
